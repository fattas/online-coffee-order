...
<html lang="en">
  <head>
    <title> FAS Coffee - Jelajahi Nikmatnya Kopi</title>
    <meta charset="utf-8">
  ...
  <body>
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="<?php echo APPURL; ?>">FAS<small>Coffee</small></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="<?php echo APPURL; ?>/services.php" class="nav-link">Layanan</a></li>
	          <li class="nav-item"><a href="<?php echo APPURL; ?>/about.php" class="nav-link">Tentang</a></li>
	         
	          <li class="nav-item"><a href="<?php echo APPURL; ?>/contact.php" class="nav-link">Kontak</a></li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="<?php echo APPURL; ?>/users/bookings.php">Reservasi</a></li>
                <li><a class="dropdown-item" href="<?php echo APPURL; ?>/users/orders.php">Pembelian</a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="<?php echo APPURL; ?>/auth/logout.php">Keluar</a></li>
              </ul>
            </li>
            <?php else: ?>
            <li class="nav-item"><a href="<?php echo APPURL; ?>/auth/login.php" class="nav-link">Masuk</a></li>
            <li class="nav-item"><a href="<?php echo APPURL; ?>/auth/register.php" class="nav-link">Daftar</a></li>
            <?php endif; ?>
