...
if(isset($_POST['submit'])) {
	...
	OR empty($_POST['phone']) OR empty($_POST['email'])) {
      echo "<script>alert('one or more inputs are empty');</script>";
		...
		town, zip_code, phone, user_id, status, total_price) VALUES(:first_name, :last_name, :state, :street_address, :town,
        ...
        <div class="row">
          <div class="col-md-12 ftco-animate">
			<form action="checkout.php" method="POST" class="billing-form ftco-bg-dark p-3 p-md-5">
				<h3 class="mb-4 billing-heading">Rincian Pengiriman</h3>
                ...
                <div class="col-md-12">
					...
					<div class="radio">
                      <p><button type="submit" name="submit" class="btn btn-primary py-3 px-4">Tetapkan dan Bayar</button></p>
