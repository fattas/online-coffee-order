        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
	            ...
	            <p class="breadcrumbs"><span class="mr-2"><a href="<?php echo APPURL; ?>">Home</a></span> <span>Detail Produk</span></p>
            </div>
    	...
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				...
    				<p class="price"><span>Rp<?php echo $singleProduct->price; ?></span></p>
    				<p>
				...
				<?php if($rowCount > 0) : ?>
					<button style="margin-top: -335px; margin-left: 632px; height: 65px;" name="submit" type="submit" class="btn btn-primary py-3 px-5" disabled >Tambahkan</button>
					<?php else : ?>
          			<button style="display: inline-block; position: relative; z-index: 1; padding: 2em; margin: -2em; margin-top: -335px; margin-left: 632px; height: 65px;" name="submit" type="submit" class="btn btn-primary py-3 px-5">Tambahkan</button>
				<?php endif; ?>
				<?php else : ?>
					<p style="margin-top: -335px; margin-left: 632px; height: 65px;">Login untuk menambahkan produk ke keranjang</p>
					<?php endif; ?>
			</form>
    			</div>
    		</div>
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            ...
            <h2 class="mb-4">Hidangan Lainnya</h2>
            <p>Jelajahi Pilihan Hidangan Variatif Kami, Temukan Kelezatan Baru untuk Memuaskan Selera Anda yang Beragam.</p>
          </div>
        </div>
        <div class="row">
        	...
        	<div class="col-md-3">
        		<div class="menu-entry">
    					...
    					<div class="text text-center pt-4">
    						...
    						<p class="price"><span>Rp<?php echo $allRelatedProduct->price; ?></span></p>
    						<p><a href="<?php echo APPURL; ?>/products/product-single.php?id=<?php echo $allRelatedProduct->id; ?>" class="btn btn-primary btn-outline-primary">Lihat</a></p>
    					</div>
    				</div>
        	</div>
			<?php endforeach; ?>
