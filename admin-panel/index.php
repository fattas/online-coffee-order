        ...
        <div class="col-md-3">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text">Total Produk: <?php echo $productsCount->count_products; ?></p>
        ...
        <div class="col-md-3">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text">Total Pesanan: <?php echo $ordersCount->count_orders; ?></p>
        ...
        <div class="col-md-3">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text">Total Reservasi: <?php echo $bookingsCount->count_bookings; ?></p>
        ...
        <div class="col-md-3">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text">Total Admin: <?php echo $adminsCount->count_admins; ?></p>
